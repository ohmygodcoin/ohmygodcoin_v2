...
const string strMessageMagic = "ohmygod Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if(pindexBest->nHeight < 1060)
    {
        nSubsidy = 400 * COIN;
    }
    else if(pindexBest->nHeight < 2060)
    {
        nSubsidy = 300 * COIN;
    }
    else if(pindexBest->nHeight < 3060)
    {
        nSubsidy = 200 * COIN;
    }
    else if(pindexBest->nHeight < 4060)
    {
        nSubsidy = 150 * COIN;
    }
    ...
    else if(pindexBest->nHeight < 6060)
    {
        nSubsidy = 100 * COIN;
    }
    else if(pindexBest->nHeight < 7060)
    {
        nSubsidy = 80 * COIN;
    }
    else if(pindexBest->nHeight < 8060)
    {
        nSubsidy = 100 * COIN;
    }
    else if(pindexBest->nHeight < 9060)
    {
        nSubsidy = 150 * COIN;
    }
...
// ohmygod: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ohmygod", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "OHMYGOD";
        CTransaction txNew;
        txNew.nTime = 1417531978;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x579503ce35eb16460c04778368ef0609106ac0f7dc928581d7d633d7f13f20df"));
        block.print();
