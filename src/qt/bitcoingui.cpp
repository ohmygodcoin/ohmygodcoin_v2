...
{
    resize(850, 550);
    setWindowTitle(tr("ohmygod") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a ohmygod address"));
  ...
  blockAction = new QAction(tr("&Block Explorer"), this);
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About ohmygod"), this);
    aboutAction->setToolTip(tr("Show information about ohmygod"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for ohmygod"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("ohmygod client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("ohmygod client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ohmygod network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid ohmygod address or malformed URI parameters."));
    }
